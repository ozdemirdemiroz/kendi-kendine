...
file= 'kendi-kendine/exceltovcf-master/Contacts.xlsx' #If your excel file in same directory with python file u can use it 
...
text_file = open("kendi-kendine/exceltovcf-master/Exported.vcf", "w")
text_file.write(s)
text_file.close()
print("Completed!")
